    ...
    public partial class Perfil1 : Form
    {
        ...
        public void lblBasket()
        {
            ...
            while (lbl < 9)
            {
                ...
                lblBasket.BackColor = Color.Transparent;
                ...
                lblEstBasket.BackColor = Color.Transparent;
        ...
        public void lblFutbol()
        {
            ...
            while (lbl < 8)
            {
                ...
                lblEstFutbol.BackColor = Color.Transparent;
                lbl++;
                posEstLblY += 40;
            }
        }
        ...
        public void lblRugby()
        {
            ...
            while (lbl < 9)
            {
                ...
                lblRugby.BackColor = Color.Transparent;
                posLblY += 40;
        ...
        public void lblVoley()
        {
            ...
            while (lbl < 7)
            {
                ...
                lblVoley.BackColor = Color.Transparent;
        ...
        private void Perfil1_Load(object sender, EventArgs e)
        {
            ...
            lblNomUser.Location = new Point(this.Width / 2 - lblNomUser.Width /2, 25);
            connection.Open();
            OleDbCommand info;
            OleDbCommand info2;
            OleDbCommand info3;
